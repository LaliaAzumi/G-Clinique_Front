    ...
    <form onSubmit={handleSubmit(handleDataBeforeSubmit)} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input {...register("numero")} className="login-input" placeholder="Numero du chambre" />
        ...
        <div>
          ...
          <input {...register("etat")} className="login-input" placeholder="true (libre) /false (occupée)" />
        </div>
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="text-xs text-primary-foreground/60 ml-1">PrixJ</label>
          <input {...register("prixJ")} className="login-input" placeholder="50 000 Ar" />
        </div>

        <div>
          <label className="text-xs text-primary-foreground/60 ml-1">etage</label>
          <input {...register("etage")} className="login-input" placeholder="2" />
        </div>
         <div>
          <label className="text-xs text-primary-foreground/60 ml-1">isSoinsIntensifs</label>
          <input {...register("isSoinsIntensifs")} className="login-input" placeholder="true/false" />
        </div>
